 ...
 * --------------------------------------------------------------------- This
 * file is part of KEGGtranslator, a program to convert KGML files from the KEGG
 * database into various other formats, e.g., SBML, GML, GraphML, and many more.
 * Please visit the project homepage at
 * <http://www.cogsys.cs.uni-tuebingen.de/software/KEGGtranslator> to obtain the
 * latest version of KEGGtranslator.
 * 
