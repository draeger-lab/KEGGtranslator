...
TODO: Eventuell noch irgendein Nebensatz, aus dem hervorgeht, dass Reaktionen nicht komplett sein müssen, sondern nur für visualisierung.
...
TODO: Mehr Infos zu der DB. und mit dem KGML format und XML dateien überleiten.
...
TODO: Preprocessing (remove white nodes, reaciton complete, etc.)

After these preprocessing steps, KEGGtranslator branches between two different conversion modes for the actual translation:


Auch erwaehnen, dass alle optionen ausschaltbar sind.
